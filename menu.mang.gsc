        ...
        if(self getVerification() > 0)
        {
            ...
            else
            {
                if(self AdsButtonPressed() || self AttackButtonPressed())
                {
                    ...
                    if(curs != self.menu["curs"][menu])6e((self AttackButtonPressed() ? 1 : -1), curs);
                    wait .13;
                }
                else if(self UseButtonPressed())
                {
                    ...
                    if(isDefined(self.menu["items"][menu].func[curs]))
                    {
                        if(self.menu["items"][menu].func[curs] == ::newMenu)
                        {
                            ...
                            self thread E8(self.menu["items"][menu].input1[curs]);
                        }
                ...
                {
                    if(self getCurrent() == "main")self vA();
                    else self newMenu();
                    wait .2;
                }
            }
